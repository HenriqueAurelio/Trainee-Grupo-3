...
--
-- Host: 127.0.0.1
-- Generation Time: 24-Jun-2020 às 18:42
...
(85, 'As Armas da PersuasÃ£o', 'As armas da persuasÃ£o.jpg', 'Depois de passar anos caindo na lÃ¡bia de vendedores, arrecadadores de doaÃ§Ãµes e operadores de telemarketing, o psicÃ³logo Robert B. Cialdini resolveu se dedicar ao estudo da persuasÃ£o. Ele queria entender quais sÃ£o os fatores que levam uma pessoa a dizer \"sim\" a um pedido e que tÃ©cnicas exploram melhor esses fatores. ', '27,00', 8),
...
(91, 'Percy Jackson e a MaldiÃ§Ã£o do TitÃ£', 'Percy jackson A maldiÃ§Ã£o do titan.jpg', 'Um chamado do amigo Grover deixa Percy a postos para mais uma missÃ£o: dois novos meios-sangues foram encontrados, e sua ascendÃªncia ainda Ã© desconhecida. Como sempre, Percy sabe que precisarÃ¡ contar com o poder de seus aliados herÃ³is, com sua leal espada Contracorrente... e com uma caroninha da mÃ£e. O que eles ainda nÃ£o sabem Ã© que os jovens descobertos nÃ£o sÃ£o os Ãºnicos em perigo: Cronos, o Senhor dos TitÃ£s, arquitetou um de seus planos mais traiÃ§oeiros, e nossos herÃ³is serÃ£o presas fÃ¡ceis. Um monstro ancestral foi despertado â€“ um ser com poder suficiente para destruir o Olimpo â€“, e Ãrtemis, a Ãºnica deusa capaz de encontrÃ¡-lo, desapareceu. Percy e seus amigos tÃªm apenas uma semana para resgatar a deusa sequestrada e solucionar o mistÃ©rio que ronda o monstro que ela caÃ§ava. Escrito por Rick Riordan', '20,00', 2),
