				...
				<div class="col-lg-5 col-md-12 mt-3 pt-5 text-center">
					...
					<div class="row social-contato">
						<ul class="redes-sociais-contato pr-5">
							<div class="row social-contato">
								<li class="mt-1 mb-3 mr-2 ml-1 responsive-contato"><br><a href="https://www.facebook.com/aurelio.tentei.7" target="_blank"><i class="fa fa-facebook fa-3x icoredesocial-contato"></i></a><br><br><p class="icodes-contato"></p>Livra Aurelio</li>					
