            ...
            <form method="POST" action="produtos/criar">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-9 form-group">
                        ...
                        <input type="text" name="nome" class="form-control" id="exampleFormControlInput1" placeholder="Nome do livro">
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-2 col-md-3"></div>
                    <div class="col-lg-5 col-md-4 form-group">
                        ...
                        <input type="number" name="categoria" class="form-control" id="exampleFormControlInput2" placeholder="Categoria do livro">
                    </div>
                    <div class="col-lg-5 col-md-5 form-group">
                        <label for="exampleFormControlNumber1">Preço</label>
                        <input type="number" step="0.01" min="0" name="preco" class="form-control" id="exampleFormControlNumber1" placeholder="Preço do livro">
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-2 col-md-3"></div>
